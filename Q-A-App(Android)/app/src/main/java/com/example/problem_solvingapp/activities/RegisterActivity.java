...
import com.example.problem_solvingapp.utils.FileUtils;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerUser() {
        ...
        if (imageFile != null) {
            ...
            // 使用 Retrofit 上传文件
            Call<QuestionApiService.RegisterResponse> call = service.register(usernameBody, passwordBody, emailBody, body);
            call.enqueue(new Callback<QuestionApiService.RegisterResponse>() {
                @Override
                public void onResponse(@NonNull Call<QuestionApiService.RegisterResponse> call, Response<QuestionApiService.RegisterResponse> response) {
                ...
                @Override
                public void onFailure(Call<QuestionApiService.RegisterResponse> call, Throwable t) {
